...
| 테이블                 | 주요 컬럼                                                                                                                            | 비고                                                                                                                                       |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `users`                | id, email, password_hash, provider, provider_id, role, plan, pro_expires_at, temp_ban_until, permanent_ban, withdrawn_at, created_at | `provider=LOCAL\|GOOGLE\|APPLE\|...`, `role=USER\|ADMIN`. `pro_expires_at`(V9)은 쿠폰/관리자 지급으로 구독과 무관하게 보장된 Pro 만료 시각 |
